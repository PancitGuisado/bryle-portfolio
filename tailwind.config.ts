    ...
    extend: {
      ...
      keyframes: {
        ...
        "blob-morph": {
          ...
          "25%": { borderRadius: "55% 45% 60% 40% / 40% 55% 45% 60%" },
          "50%": { borderRadius: "45% 55% 40% 60% / 60% 45% 55% 40%" },
          "75%": { borderRadius: "60% 40% 45% 55% / 45% 60% 40% 55%" },
        },
        "blob-morph-2": {
          "0%, 100%": { borderRadius: "55% 45% 40% 60% / 45% 55% 45% 55%" },
          "33%": { borderRadius: "40% 60% 55% 45% / 60% 40% 55% 45%" },
          "66%": { borderRadius: "60% 40% 45% 55% / 40% 60% 45% 55%" },
        },
        "float": {
      ...
      animation: {
        ...
        "blob-morph-2": "blob-morph-2 14s ease-in-out infinite",
        "float": "float 6s ease-in-out infinite",
        "float-delayed": "float-delayed 8s ease-in-out infinite",
        "pulse-ring": "pulse-ring 4s ease-in-out infinite",
        "spin-slow": "spin-slow 20s linear infinite",
        "skill-fill": "skill-fill 1.2s cubic-bezier(0.16, 1, 0.3, 1) forwards",
