    ...
    <div ref={widgetRef} className="relative">
      <button
        ...
        className={`flex h-9 w-9 items-center justify-center rounded-full border transition-all duration-300 active:scale-95 ${
          open
            ? "border-[#1DB954]/40 bg-[#1DB954]/10 text-[#1DB954] shadow-[0_0_12px_rgba(29,185,84,0.15)]"
            : "border-border text-muted-foreground hover:border-[#1DB954]/30 hover:bg-[#1DB954]/5 hover:text-[#1DB954]"
        }`}
        aria-label="Spotify"
        title="My Music"
      >
        ...
        <div className="w-[300px] sm:w-[320px] overflow-hidden rounded-2xl border border-border bg-background/95 shadow-2xl backdrop-blur-xl">
          ...
          <div className="p-2">
            <iframe
              ...
              src="https://open.spotify.com/embed/playlist/6IwofV5Bht9A3Yg4pIxUta?utm_source=generator&theme=0"
              width="100%"
              height="352"
              frameBorder="0"
